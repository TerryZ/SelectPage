...
;(function($){
	...
	SelectPage.prototype.setElem = function(combo_input) {
		...
		//result list box
		if(orgWidth > 300){
			elem.result_area = $('<div style="width: '+orgWidth+'px">').addClass(css.re_area);
		} else {
	...
	SelectPage.prototype.setNavi = function(self, cnt_whole, cnt_page, page_num) {
		...
		var buildPageNav = function(self, pagebar, page_num, last_page) {
			...
			if (pagebar.find('li').length === 0) {
				var fpnl_page_width = ($(pagebar).parent().parent().width()-178)/4;
				if(fpnl_page_width < 30){
					fpnl_page_width = 30;
				}
				pagebar.hide().empty();
				...
				pagebar.append('<li class="csFirstPage" title="' + msg.first_title + '" ><a href="javascript:void(0);" style="width: '+fpnl_page_width+'px"> <i class="'+iconFist+'"></i> </a></li>');
				pagebar.append('<li class="csPreviousPage" title="' + msg.prev_title + '" ><a href="javascript:void(0);" style="width: '+fpnl_page_width+'px"><i class="'+iconPrev+'"></i></a></li>');
				//pagination information
				pagebar.append('<li class="pageInfoBox"><a href="javascript:void(0);"> ' + updatePageInfo() + ' </a></li>');

				pagebar.append('<li class="csNextPage" title="' + msg.next_title + '" ><a href="javascript:void(0);" style="width: '+fpnl_page_width+'px"><i class="'+iconNext+'"></i></a></li>');
				pagebar.append('<li class="csLastPage" title="' + msg.last_title + '" ><a href="javascript:void(0);" style="width: '+fpnl_page_width+'px"> <i class="'+iconLast+'"></i> </a></li>');
				pagebar.show();
			}else{
