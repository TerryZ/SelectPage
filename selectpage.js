...
;(function($){
	...
	$.extend(SelectPage.prototype,{
		...
		_searchForDb: function(self, q_word, which_page_num) {
			if(!self.option.ajax_success && $.isFunction(self.option.ajax_success)) self._hideResults(self);
			/**
			 * 增加自定义查询参数
			 */
